...
# ===== Styles (coffee gradient + readable cards) =====
st.markdown("""
<style>
:root{
...
# ===== Sidebar nav =====
page = st.sidebar.radio("Navigate", ["Home","Menu","Build Your Drink","Budget Planner","Sustainability","Contact"])
...
if page == "Home":
    ...
    # Hero banner with the café image used creatively (not as page bg)
    st.markdown("""
    <div class="hero">
